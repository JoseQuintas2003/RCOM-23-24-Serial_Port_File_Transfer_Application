                      ...
                      int nTries, int timeout, const char *filename)
{
    ...
    case LlTx: {
        ...
        //Encoding file size
        unsigned char len4 = fileSize / pow(256, 3);
        unsigned char len3 = (fileSize - len4 * pow(256, 3)) / pow(256, 2);
        unsigned char len2 = (fileSize - len4 * pow(256, 3) - len3 * pow(256, 2)) / 256;
        unsigned char len1 = fileSize - len4 * pow(256, 3) - len3 * pow(256, 2) - len2 * 256;
